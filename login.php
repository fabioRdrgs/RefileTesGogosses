...
if (isset($_POST['submit'])) {
    ...
    if (checkIfEmailExists($uEmail)) {
        ...
        if (password_verify($uPswd, $userInfo['mdp'])) {
            ...
            echo "<div id=\"errorDiv\" class=\"alert alert-danger\" role=\"alert\">Mot de passe invalide !</div>";
    } else
        echo "<div id=\"errorDiv\" class=\"alert alert-danger\" role=\"alert\">Cet email n'existe pas !</div>";
}
?>
<!DOCTYPE html>
<html>
...
<body class="text-center">
    <div class="container-fluid p-5">
        <form class="form-signin p-5" action="login.php" method="POST">
            ...
            <a href="signup.php">
                <p class="mt-2">Pas de compte? Inscrivez-vous</p>
            </a>
